window.onload = function(){
    ...
    function applyFilter(){
        ...
        if(opacityMask.value*1 != 0){
            ...
            // Desenhe um retângulo preenchido com a cor definida
            ctx.fillRect(0, 0, canvas.width, canvas.height);
            ctx2.fillRect(0, 0, canvasPrincial.width, canvasPrincial.height);
        }
...
/*
const canvas = document.getElementById('seuCanvas'); // Substitua 'seuCanvas' pelo ID real do seu elemento canvas
const ctx = canvas.getContext('2d');

// Sua imagem base64
const imagemBase64 = 'data:image/png;base64,iVBORw0KG...'; // Substitua pelo seu código base64
